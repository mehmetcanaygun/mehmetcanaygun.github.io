function dashboard(id, fData) {
  ...
  function segColor(c) {
    return { cinema: "#807dba", theatre: "#e08214", library: "#41ab5d" }[c];
  }

  // compute total for each state.
  fData.forEach(function(d) {
    d.total = d.freq.cinema + d.freq.theatre + d.freq.library;
  });
  ...
  function histoGram(fD) {
    ...
    bars
      ...
      .attr("fill", barColor)
      .on("mouseover", mouseover) // mouseover is defined becinema.
      .on("mouseout", mouseout); // mouseout is defined becinema.
  ...
  var tF = ["cinema", "theatre", "library"].map(function(d) {
    return {
      type: d,
      freq: d3.sum(
